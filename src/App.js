...
const App = () => {
  ...
  const joinChannel = async () => {
    const token = '007eJxTYDgmcL2DdZPn+/fPFvHyL/wwydhO78T2D3JLGm9c2hgnHNiowJBsaWSSlGKWlmRqnmRikmRoYWCZbGBuYpZkbmFhbppiwfafLaUhkJHhGrMWMyMDBIL47Ax+iWWJJYlFDAwA8FggcA=='; // or generate a token server-side
